...
<div class="my-5 mx-auto px-4 sm:px-6 lg:px-8 w-full xl:w-2/3">
    <div class="sm:flex sm:items-center">
        <form class="space-y-8 divide-y divide-gray-200" action="${pageContext.request.contextPath}/medecin/add"
              method="post">
                ...
                <div class="space-y-6 sm:space-y-5">
                    ...
                    <div class="pt-5">
                        <div class="flex justify-end">
                            <a href="${pageContext.request.contextPath}/medecin/index" type="button"
